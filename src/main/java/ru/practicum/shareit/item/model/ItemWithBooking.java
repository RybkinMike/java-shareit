...
public class ItemWithBooking {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && count == that.count && requestId == that.requestId && Objects.equals(name, that.name) && Objects.equals(description, that.description) && Objects.equals(user, that.user) && Objects.equals(available, that.available) && Objects.equals(lastBooking, that.lastBooking) && Objects.equals(nextBooking, that.nextBooking) && Objects.equals(comments, that.comments);
    }
