...
class BookingServiceImplTest2 {
    ...
    void approveBookingTest() {
        ...
        User userFromBase2 = userService.getAllUsers().get(1);
        ItemDto itemDto = new ItemDto();
        itemDto.setName("i1");
        itemDto.setAvailable(true);
        itemService.addNewItem(userFromBase.getId(), itemDto);
        List<ItemWithBooking> itemsFromBase = (List<ItemWithBooking>) itemService.getItems(userFromBase.getId(), 1, 10);
